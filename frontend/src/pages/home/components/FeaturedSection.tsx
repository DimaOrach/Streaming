import FeaturedGridSkeleton from "@/pages/home/components/FeaturedGridSkeleton";
...
const FeaturedSection = () => {
    ...
    return <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        {featuredSongs.map((song) => (
            ...
            hover:bg-zinc-500/50 transition-colors group cursor-pointer relative"
            >
            ...
            <div className="flex-1 p-4">
                ...
                {/* Play button on main page (Good Afternoon, homie) */}
